...
public class GravilloPlanetGenerator extends PlanetGenerator {
...

    {
        defaultLoadout = new Schematic(
                Seq.with(new Schematic.Stile(GrBlocks.coreBase, 0, 0, null, (byte)0)),
                new StringMap(), 4, 4
        );
    }
    ...
    Block[][] arr = {
            ...
            {Blocks.ice, Blocks.ice, Blocks.ice, Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.stone, GrBlocks.corundum, Blocks.shale, Blocks.shale, Blocks.stone, Blocks.stone, Blocks.stone},
            {Blocks.ice, Blocks.iceSnow, Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.stone, GrBlocks.corundum, Blocks.shale, Blocks.shale, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone},
            {Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.stone, GrBlocks.corundum, Blocks.shale, Blocks.shale, Blocks.stone, Blocks.stone, Blocks.redIce, Blocks.redIce, Blocks.redIce},
            {Blocks.snow, Blocks.snow, Blocks.snow, Blocks.stone, GrBlocks.corundum, Blocks.stone, Blocks.shale, Blocks.stone, Blocks.stone, Blocks.redIce, Blocks.redIce, Blocks.redIce, Blocks.redIce},
            {Blocks.snow, Blocks.snow, Blocks.stone, GrBlocks.corundum, Blocks.stone, Blocks.shale, Blocks.shale, Blocks.stone, Blocks.stone, Blocks.redIce, Blocks.redIce, Blocks.redIce, Blocks.redIce},
    };
    ...
    protected void generate() {
        ...
        Seq<Block> ores = Seq.with(/*TODO: GrBlocks.oreCobalt,*/ Blocks.oreLead);
